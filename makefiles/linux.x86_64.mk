...
arch_ha = arch/+x86_64/cpuid.ha arch/fenv_defs.ha
$(HARECACHE)/arch.ssa: $(arch_ha)
	@mkdir -p -- "$(HARECACHE)"
	@printf 'HAREC\t%s\n' "$@"
	@$(TDENV) $(HAREC) $(HARECFLAGS) -o $@ -t $(HARECACHE)/arch.td.tmp -N arch $(arch_ha)

arch_s = $(HARECACHE)/arch.s arch/+x86_64/cpuid.s arch/+x86_64/fenv.s

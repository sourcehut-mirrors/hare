...
sys_ha = sys/+haiku/+x86_64.ha sys/+haiku/dynamic_linker.ha sys/+haiku/errno.ha sys/+haiku/signal.ha sys/+haiku/socket.ha sys/+haiku/syscalls.ha sys/+haiku/types.ha sys/u64tos.ha sys/unknown_errno.ha
...
unix_signal_ha = unix/signal/+haiku.ha unix/signal/types.ha
